 ...
 *
 * Варіант 9: склади "бу мі ча ро ні ке зу ла фо", 5 імен, 3 склади
 */
...
function generateAnimalName(array $syllables, int $count = 3): string
{
    ...
    // Робимо першу літеру великою (працює і з кирилицею)
...
$syllablesInput = $_POST['syllables'] ?? 'бу мі ча ро ні ке зу ла фо';
    ...
    <div class="demo-card">
        ...
        <form method="post" class="demo-form">
            <div>
                ...
                <input type="text" id="syllables" name="syllables" value="<?= htmlspecialchars($syllablesInput) ?>" placeholder="бу мі ча ро...">
            </div>
            <div class="form-row">
                <div>
