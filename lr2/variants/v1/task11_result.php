...
$results = [
        ['func' => 'sin', 'expression' => "sin($x)", 'value' => my_sin($x)],
        ['func' => 'cos', 'expression' => "cos($x)", 'value' => my_cos($x)],
        ['func' => 'tg',  'expression' => "tan($x)", 'value' => my_tan($x)],
        ['func' => 'my_tg', 'expression' => "sin($x)/cos($x)", 'value' => my_tg($x)],
        ['func' => 'Степінь', 'expression' => "{$x}^{$y}", 'value' => my_pow($x, $y)],
        ['func' => 'Факторіал', 'expression' => (int)$x . '!', 'value' => my_factorial((int)$x)],
];
